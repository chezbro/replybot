            ...
            <li key={email.id} className="p-6 hover:bg-gray-50 transition duration-150 ease-in-out">
              <div className="flex justify-between items-start">
                ...
                <div className="mt-2">
                  <Link
                    href={`/email/${email.id}`}
                    className="inline-flex items-center px-2 py-1 text-xs font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition duration-150 ease-in-out sm:px-4 sm:py-2 sm:text-base"
                  >
                    View Thread
                  </Link>
                </div>
